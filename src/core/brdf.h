...
class BRDF {
public:
    virtual vec3 calcBRDF(Shade &shade, dvec3 &in, const dvec3 &out) { return vec3(); }
    virtual vec3 sampleBRDF(Shade &shade, dvec3 &in, const dvec3 &out, float *pdf = nullptr) = 0;
